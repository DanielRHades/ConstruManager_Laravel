<div id="form_add_material" class=" fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50 z-50">
...
<script>
    function closeMaterial() {
        document.querySelector('#form_add_material').classList.add('hidden');
    }
</script>
