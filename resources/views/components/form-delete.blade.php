<div id="form_delete" class="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50 z-50">
    <div class="bg-white p-8 rounded-lg shadow-md w-96">
        ...
        <form method="get" action="{{route($section.'.delete',['id'=>$id])}}">
            @csrf
            <div class="flex justify-end">
                ...
                <button type="button" class="bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded" onclick="closeDelete()">Cancelar</button>
            </div>
        </form>
    </div>
</div>
